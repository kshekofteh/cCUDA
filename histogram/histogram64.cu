...
static const uint MAX_PARTIAL_HISTOGRAM64_COUNT = 32768*16;
...
)
{
	...
	printf("histogram64Kernel, Blocks: %d, Threads: %d\n", histogramCount, HISTOGRAM64_THREADBLOCK_SIZE);
	...
	printf("mergeHistogram64Kernel, Blocks: %d, Threads: %d\n", HISTOGRAM64_BIN_COUNT, MERGE_THREADBLOCK_SIZE);
